  ...
  return (
    <section id="testimonials" className="py-24 lg:py-32 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="overflow-hidden animate-on-scroll fade-up">
          <div className="testimonial-track">
            {TESTIMONIALS.map((item) => (
              <div key={item.name} className="testimonial-slide px-3">
                <div className="bg-background rounded-3xl p-8 border border-gray-100 h-full">
                  ...
                  <p className="text-text-light leading-relaxed mb-8">&ldquo;{item.quote}&rdquo;</p>
